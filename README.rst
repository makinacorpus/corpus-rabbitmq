===========================================================================
Exemple of a generic rabbitmq server deployment with salt/makina-states
===========================================================================
...
Note
-------
We install the admin interface proxified by nginx, you can access with the 'admin' and password got with salt-call --local -lall mc_rabbitmq.settings.
